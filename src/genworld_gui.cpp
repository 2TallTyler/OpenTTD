			...
			NWidget(NWID_HORIZONTAL), SetPIP(0, WidgetDimensions::unscaled.hsep_wide, 0),
				...
				NWidget(NWID_HORIZONTAL), SetPIP(0, WidgetDimensions::unscaled.hsep_normal, 0),
					...
					NWidget(NWID_VERTICAL, NWidContainerFlag::EqualSize), SetPIP(0, WidgetDimensions::unscaled.vsep_sparse, 0),
						...
						NWidget(WWT_DROPDOWN, COLOUR_ORANGE, WID_GL_AVGHEIGHT_PULLDOWN), SetToolTip(STR_CONFIG_SETTING_AVERAGE_HEIGHT_HELPTEXT), SetFill(1, 1),
...
static const StringID _avgheight[]   = {STR_CONFIG_SETTING_AVERAGE_HEIGHT_CLIMATE, STR_CONFIG_SETTING_AVERAGE_HEIGHT_LOWLANDS, STR_CONFIG_SETTING_AVERAGE_HEIGHT_NORMAL, STR_CONFIG_SETTING_AVERAGE_HEIGHT_PLATEAUS};
...
struct GenerateLandscapeWindow : public Window {
	...
	std::string GetWidgetString(WidgetID widget, StringID stringid) const override
	{
		switch (widget) {
			...
			case WID_GL_AVGHEIGHT_PULLDOWN:  return GetString(_avgheight[_settings_newgame.game_creation.average_height]);
	...
	void UpdateWidgetSize(WidgetID widget, Dimension &size, [[maybe_unused]] const Dimension &padding, [[maybe_unused]] Dimension &fill, [[maybe_unused]] Dimension &resize) override
	{
		...
		switch (widget) {
			...
			case WID_GL_AVGHEIGHT_PULLDOWN:  strs = _variety; break;
	...
	void OnClick([[maybe_unused]] Point pt, WidgetID widget, [[maybe_unused]] int click_count) override
	{
		switch (widget) {
			...
			case WID_GL_AVGHEIGHT_PULLDOWN: // Average height
				ShowDropDownMenu(this, _avgheight, _settings_newgame.game_creation.average_height, WID_GL_AVGHEIGHT_PULLDOWN, 0, 0);
				break;
	...
	void OnDropdownSelect(WidgetID widget, int index, int) override
	{
		switch (widget) {
			...
			case WID_GL_AVGHEIGHT_PULLDOWN:     _settings_newgame.game_creation.average_height = index; break;
